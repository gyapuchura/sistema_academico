...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">MODIFICAR TEMÁTICA</h2>
			</div>
		</div>
	</div>
	</section>
    ...
    <h4 align="center"><a href="tematicas.php">VOLVER A TEMÁTICAS</a></h4>
  </div>
</br>
    </div>
...
<!-- javascript --->
<form name="FORM9" action="guarda_mod_tematica.php" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">MODIFICAR LA TEMÁTICA</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ¿Esta seguro de modificar la Temática?
       </div>
