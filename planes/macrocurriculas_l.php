...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
       ...
       <p>EN ESTA SECCIÓN SE REALIZA LA GESTIÓN DE MACROCURRÍCULAS.</p>
    </div>
    </div>
...
$(document).ready(function(){
   $("#idobjetivo_anual").change(function () {
            ...
            $.post("macrocurricula_m.php", { objetivo_anual:objetivo_anual }, function(data){
            $("#macrocurricula_m").html(data);
            });
        });
   })
});
