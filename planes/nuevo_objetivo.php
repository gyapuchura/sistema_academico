...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">NUEVO OBJETIVO ANUAL</h2>
			</div>
		</div>
	</div>
	</section>
    ...
    <h4 align="center"><a href="objetivos_anuales.php">VOLVER A OBJETIVOS</a></h4>
  </div>
</br>
    </div>
...
<!-- javascript --->
<form name="FORM9" action="guarda_objetivo.php" method="post">

<div class="box-area">

<div class="row">
  <div class="col-md-4"><h4>DESCRIPCIÓN DEL OBJETIVO:</h4></div>
  <div class="col-md-8"><textarea class="form-control" rows="3" name="objetivo_anual" required></textarea></div> 
</div>

<div class="row">
  <div class="col-md-3"><h4>META (Número de Eventos):</h4></div>
  <div class="col-md-3"><input type="text" class="form-control" name="meta" required></div> 
  <div class="col-md-3"><h4>PRESUPUESTO ASIGNADO [Bs]:</h4></div>
  <div class="col-md-3"><input type="text" class="form-control" name="presupuesto" required></div>  
</div>
