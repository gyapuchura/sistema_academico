...
$sql0 =" SELECT idobjetivo_anual, codigo, objetivo_anual FROM objetivo_anual WHERE idplan_anual='$idplan_anual_ss' ";
...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">MACROCURRÍCULAS</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
        ...
        <h4 align="center"><a href="objetivos_anuales.php">VOLVER</a></h4>
		</div>
   	<div class="about-logo">

       <h3 align="center">MACROCURRÍCULAS DEL OBJETIVO <?php echo $row0[1]?> </h3>

       <h3 class="text-muted"><?php echo $row0[2]?></h3>

    </div>
    </div>
    <div class="row">
        <form name="FORMU" action="nueva_macrocurricula.php" method="post">
        <button type="submit" class="btn btn-primary">NUEVA MACROCURRICULA</button>
        </form>
    </div>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            ?>
                ...
                <td>                                                
                <form name="VALIDA" action="valida_macrocurricula_mod.php" method="post">
                ...
                <td>                                                
                <form name="VALIDA" action="valida_macrocurricula.php" method="post">
                <input name="idmacrocurricula" type="hidden" value="<?php echo $row[0];?>">
                <button type="submit" class="btn btn-primary">VER MALLA</button></form>
                </td>
                </tr>  
            <?php
            $numero=$numero+1;  
