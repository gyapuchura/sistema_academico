...
<table id="example2" class="table table-striped table-bordered table-hover" cellspacing="1" width="100%">
    ...
    <?php
    $numero=1;
    $sql =" SELECT idobjetivo_anual, idplan_anual, codigo, correlativo, objetivo_anual, meta, presupuesto FROM objetivo_anual WHERE idplan_anual='$idplan_anual'";
    ...
    ?>
        <tr>
            ...
            <td><?php echo $row[6];?></td>
                            <td>                                                
            <form name="VALIDA" action="valida_objetivo_mod_o.php" method="post">
