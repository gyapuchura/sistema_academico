...
<script language="javascript" src="../js/jquery-3.1.1.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">MICROCURRÍCULAS</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
       ...
       <p>EN ESTA SECCIÓN SE REALIZA LA GESTIÓN DE MICROCURRÍCULAS.</p>
    </div>
    </div>
...
<div class="row">
  ...
  <div class="col-md-9">
  <select name="idobjetivo_anual"  id="idobjetivo_anual" class="form-control" required></select>
  </div> 
  </div>
...
$(document).ready(function(){
   $("#idplan_anual").change(function () {
           $("#idplan_anual option:selected").each(function () {
            plan_anual=$(this).val();
            $.post("objetivo_anual_m.php", {plan_anual:plan_anual}, function(data){
            $("#idobjetivo_anual").html(data);
            });
        });
   })
});
...
$(document).ready(function(){
   $("#idobjetivo_anual").change(function () {
            ...
            $.post("macrocurricula_obj.php", { objetivo_anual:objetivo_anual }, function(data){
...
$(document).ready(function(){
   $("#idmacrocurricula").change(function () {
            ...
            $.post("microcurricula_obj.php", { macrocurricula:macrocurricula }, function(data){
            $("#microcurricula").html(data);
            });
        });
   })
});
