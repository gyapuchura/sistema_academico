...
<link rel="stylesheet" href="../css/style.css">
    ...
    <div class="row">
    <div class="col-md-8"><h3>1.- DATOS PERSONALES DEL USUARIO:</h3></div>
    <div class="col-md-4"></div>
    </div>
<!-- javascript --->
<form name="FORM9" action="guarda_usuario.php" method="post">
...
<div class="box-area">
    ...
    <select name="exp"  id="exp" class="form-control" required>
        ...
        echo "<option value=". $row1[2].">". $row1[2]." - ". $row1[1]."</option>";
    ...
    <div class="row">
    <div class="col-md-8"><h3>1-a.- PERFIL DEL USUARIO:</h3></div>
    <div class="col-md-4"></div>
    </div>
    ...
    <div class="col-md-3"><h3>ELEGIR PERFIL:</h3></div>
    <div class="col-md-3">
    ...
    <div class="row">
    <div class="col-md-8"><h3>2.- DATOS COMPLEMENTARIOS DEL USUARIO:</h3></div>
    <div class="col-md-4"></div>
    </div>

    <div class="box-area">
    <div class="row">
    <div class="col-md-3"><h4>FORMACIÓN ACADÉMICA USUARIO:</h4></div>
    <div class="col-md-3">
    <select name="idformacion_academica"  id="idformacion_academica" class="form-control" required>
        <option value="">-SELECCIONE-</option>
        <?php
        $sql1 = "SELECT idformacion_academica, formacion_academica FROM formacion_academica WHERE idformacion_academica != '1'";
        $result1 = mysqli_query($link,$sql1);
        if ($row1 = mysqli_fetch_array($result1)){
        mysqli_field_seek($result1,0);
        while ($field1 = mysqli_fetch_field($result1)){
    ...
    <div class="row">
    <div class="col-md-3"><h4>RESIDENCIA ACTUAL:</h4></div>
    <div class="col-md-3">
    ...
    <div class="col-md-3"><h4>DIRECCIÓN DOMICILIO:</h4></div>
    <div class="col-md-3">
    <textarea class="form-control" rows="3" name="direccion_dom" required></textarea> 
    </div>
    </div>
    ...
    <div class="row">
    <div class="col-md-6"><h3>3.- DATOS LABORALES DEL USUARIO:</h3></div>
    ...
    <div class="row">
    <div class="col-md-3"><h4>DEPENDENCIA LABORAL DEL USUARIO:</h4></div>
    <div class="col-md-3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Esta seguro de registrar al nuevo usuario?
