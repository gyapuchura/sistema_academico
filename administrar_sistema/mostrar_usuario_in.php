...
$idusuario_in_ss = $_SESSION['idusuario_in_ss'];
$idnombre_in_ss = $_SESSION['idnombre_in_ss'];
...
$sql_n.=" WHERE usuarios.idnombre=nombre.idnombre AND usuarios.idusuario='$idusuario_in_ss' ";
...
$sql_c.=" AND usuarios.idusuario=nombre_datos.idusuario AND nombre.idnombre='$idnombre_in_ss' ";
...
$sql_l.= " FROM dato_laboral WHERE idnombre='$idnombre_in_ss' ORDER BY iddato_laboral DESC LIMIT 1";
...
<div class="form-group row">
  ...
  <div class="row">
    <div class="col-md-6"><h3>2.- DATOS COMPLEMENTARIOS: <?php echo $idusuario_mod_ss;?> </h3></div>
    <div class="col-md-6"></div>
  </div>
...
<div class="col-md-3">
      <select name="idformacion_academica"  id="idformacion_academica" class="form-control" disabled >
          <option selected>Seleccione</option>
          <?php
...
<div class="col-md-3">
        <select name="idprofesion"  id="idprofesion" class="form-control" disabled >
          <option selected>Seleccione</option>
          <?php
...
<div class="col-md-3"><input type="mail" class="form-control" name="correo" value="<?php echo $row_c[4];?>" disabled></div>
<div class="col-md-3"><h4>TELÉFONO CELULAR/WHATSAPP:</h4></div>
<div class="col-md-3"><input type="text" class="form-control" name="celular" value="<?php echo $row_c[5];?>" disabled></div>
</div>

<div class="row">
<div class="col-md-3"><h4>DEPARTAMENTO DE RESIDENCIA:</h4></div>
<div class="col-md-3">
<select name="idresidencia"  id="idresidencia" class="form-control" disabled >
          <option selected>Seleccione</option>
          <?php
    ...
    <div class="col-md-4"><textarea class="form-control" rows="3" name="direccion_dom" disabled><?php echo $row_c[6];?></textarea></div>
    </div>
</div>
