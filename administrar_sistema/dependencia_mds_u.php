...
$(document).ready(function(){
   $("#idministerio").change(function () {
           $("#idministerio option:selected").each(function () {
            ministerio=$(this).val();
            $.post("direccion_u.php", { ministerio:ministerio }, function(data){
...
$(document).ready(function(){
   $("#iddireccion").change(function () {
            ...
            direccion=$(this).val();
            $.post("areas_u.php", { direccion:direccion }, function(data){
            $("#idarea").html(data);
            });
        });
   })
...
$(document).ready(function(){
   $("#iddepartamento").change(function () {
            ...
            $.post("red_salud_u.php", { departamento:departamento }, function(data){
...
$(document).ready(function(){
   $("#idred_salud").change(function () {
            $("#idred_salud option:selected").each(function () {
                red_salud=$(this).val();
            $.post("establecimiento_salud_u.php", { red_salud:red_salud }, function(data){
