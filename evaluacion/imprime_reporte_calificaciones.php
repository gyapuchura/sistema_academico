...
while ($field = mysqli_fetch_field($result)){
    ...
    ?>
        ...
        <td style="font-size: 11px; text-align: center;"><?php echo $row[0];?></td>
        <td style="font-size: 11px"><?php echo $row[1];?> <?php echo $row[2];?><span style="text-align: center"></span></td>
        <td style="font-size: 11px; text-align: center;"><?php echo mb_strtoupper($row[6]);?></td>
        <td style="text-align: center; font-size: 11px;"><?php echo mb_strtoupper($row[4]);?></td>
        <td style="text-align: center; font-size: 11px;"><?php echo mb_strtoupper($row[5]);?></td>
        ...
        <td style="font-size: 11px; text-align: center;"><?php echo $row[9];?></td>
        <td style="font-size: 11px; text-align: center;"><?php echo $row[11];?></td>
        <td style="font-size: 11px; text-align: center;"><?php echo $row[12];?></td>
        </tr>
		<?php
$numero = $numero+1; 
}
