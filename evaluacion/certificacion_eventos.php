...
$rowus = mysqli_fetch_array($resultus);?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">CERTIFICACIÓN EVENTOS</h2>
			</div>
		</div>
	</div>
	</section>
...
<div class="table-responsive">
      <table class="table table-bordered" id="example" width="100%" cellspacing="0">
            ...
            ?>
                ...
                <td>     
                <?php  if ($row[6] == '4') { ?>
                    <form name="VALIDA" action="valida_evento_certif.php" method="post">
                    <input name="codigo" type="hidden" value="<?php echo $row[1];?>">
                    <input name="idevento" type="hidden" value="<?php echo $row[0];?>">
                    <button type="submit" class="btn-link">EMITIR CERTIFICADOS</button></form>
                <?php } else { ?>
                       EN EVALUACION
                    <?php  } ?>  
                </td>
