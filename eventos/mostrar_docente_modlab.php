...
<div class="topbar">
  <div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">DATOS LABORALES DOCENTE</h2>
			</div>
		</div>
	</div>
	</section>
...
<!-- MUESTRA EL REGSITRO DOCENTE --->

<div class="row">
    <div class="col-md-9"><h3 class="text-success">ACTUALIZAR DATOS LABORALES DEL DOCENTE:</h3></div>
...
<form name="LABORALES" action="guarda_laborales_docente.php" method="post">
...
<div class="box-area">
        ...
        <div class="row">
        <div class="col-md-6"><h4 class="text-success">DEPENDENCIA LABORAL DEL DOCENTE:</h4></div>
        <div class="col-md-6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="datosLaboralesLabel">ACTUALIZAR DATOS LABORALES DEL DOCENTE</h5>
