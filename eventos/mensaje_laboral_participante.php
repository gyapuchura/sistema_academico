...
?>
	...
	<div class="container">
        ...
        <div class="col-md-8"> <h4 class="text-success">LOS DATOS LABORALES DEL PARTICIPANTE</h4>
                                <h4 class="text-success">FUERON MODIFICADOS CORRECTAMENTE!!!</h4> </div>
        </div>

<!-- MUESTRA LA PREINSCRIPCION REALIZADA --->

   <form name="FORM9" action="mostrar_participante_mod.php" method="post">
    <div class="row">
      <div class="col-md-4"></div>
       <div class="col-md-8"> 
