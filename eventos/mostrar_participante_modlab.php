...
$sql_l.= " FROM dato_laboral WHERE iddato_laboral='$iddato_laboral' ";
  ...
  <div class="container">
	...
	<section id="inner-headline">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="pageTitle">DATOS LABORALES PARTICIPANTE</h2>
                </div>
            </div>
        </div>
	</section>
	<section id="content">
	<div class="container">
  <h4 align="center"><a href="mostrar_participante_mod.php">VOLVER</a></h4>
</br>
<!-- MUESTRA EL REGSITRO participante --->

<div class="row">
    <div class="col-md-9"><h3 class="text-success">ACTUALIZAR DATOS LABORALES DEL PARTICIPANTE:</h3></div>
...
<!------- modificacion de datos laborales ---->

<form name="LABORALES" action="guarda_laborales_participante.php" method="post">

<input type="hidden" name="idnombre" value="<?php echo $row_n[14];?>">
<input type="hidden" name="idusuario_in" value="<?php echo $row_d[1];?>">
<input type="hidden" name="idnombre_datos" value="<?php echo $row_n[16];?>">
<input type="hidden" name="idresidencia" value="<?php echo $row_d[5];?>">

<div class="box-area">
        
        <div class="row">
        <div class="col-md-6"><h4 class="text-success">DEPENDENCIA LABORAL DEL PARTICIPANTE:</h4></div>
        <div class="col-md-6">
...
<!----- end actualizar datos laboralkes ------->
      <div class="row">
        <div class="col-md-4"><h4></h4></div>
        <div class="col-md-8">    
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#datosLaborales">
...
<div class="modal fade" id="datosLaborales" tabindex="-1" role="dialog" aria-labelledby="datosLaboralesLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="datosLaboralesLabel">ACTUALIZAR DATOS LABORALES DEL PARTICIPANTE</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                ...
                Esta seguro de ACTUALIZAR los datos laborales del participante?
