...
<div class="topbar">
  <div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">MODIFICAR HORARIOS DEL EVENTO</h2>
			</div>
		</div>
	</div>
	</section>
...
<form name="FORM11" action="elimina_horario_mod.php" method="post">
...
<form name="FORMh" action="guarda_horario_mod.php" method="post">
<div class="box-area">
...
<div class="row">
<div class="col-md-4"><a href="mostrar_evento_mod.php"><h4>VOLVER</h4></a></div>
<div class="col-md-4">
...
<div class="col-md-4">
<a href="eventos.php"><h4>SALIR DE MODIFICACIÓN</h4></a>
</div>
</div>
