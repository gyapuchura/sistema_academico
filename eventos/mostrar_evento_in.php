...
$sql_e.=" departamento.departamento, provincias.provincia, municipios.municipio, nombre.nombre, nombre.paterno, nombre.materno, microcurricula.codigo, tipo_inscripcion.tipo_inscripcion ";
$sql_e.=" FROM evento, objetivo_anual, macrocurricula, microcurricula, tematica, publicacion, modalidad, departamento, municipios, provincias, nombre, usuarios, docente, tipo_inscripcion ";
...
$sql_e.=" AND evento.idmunicipio=municipios.idmunicipio AND evento.iddocente=docente.iddocente AND docente.idusuario=usuarios.idusuario AND evento.idtipo_inscripcion=tipo_inscripcion.idtipo_inscripcion ";
...
<div class="topbar">
  <div class="container">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">EVENTO PROGRAMADO</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
        ...
        <h2 align="center" class="text-success">SE HA CONSOLIDADO EL EVENTO:</h2> 
        <h2 align="center"><?php echo $codigo_evento_ss;?></h2> 
    <h2 align="center"><?php echo $row_e[6];?></h2> 
  </div>
</br>
    </div>
...
<div class="row">
  ...
  <div class="col-md-3"><h4 class="text-muted"><?php echo $row_e[12];?></h4></div>
  <div class="col-md-3"><h4>TIPO DE CONFIRMACIÓN DE INSCRIPCIÓN:</h4></div>
  <div class="col-md-3"><h4 class="text-muted"><?php echo $row_e[20];?></h4></div>
</div>
...
<div class="col-md-4"><a href="eventos.php"><h2 class="text-success">IR A EVENTOS</h2></a></div>
</div>
