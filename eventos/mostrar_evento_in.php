...
$sql_e.=" AND evento.idmunicipio=municipios.idmunicipio AND evento.iddocente=usuarios.idusuario AND evento.idtipo_inscripcion=tipo_inscripcion.idtipo_inscripcion ";
