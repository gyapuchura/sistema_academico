...
<div class="row">
    <div class="col-md-12">
        <h2 class="text-success" align="center">SE REGISTRÓ CORRECTAMENTE AL DOCENTE!!!</h2>
    </div>
</div>
...
<div class="row">
  ...
  <div class="col-md-4"></div>
<div class="col-md-4"><a href="docentes.php"><h4 class="text-primary">CONTINUAR</h4></div> 
