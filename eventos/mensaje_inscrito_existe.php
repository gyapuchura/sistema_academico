...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">INSCRIPCIÓN DENEGADA</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
        <div class="row">
        <div class="col-md-8"><h2 class="text-danger">NO ES POSIBLE PROCESAR LA PREINSCRIPCIÓN:</h2></div>
        <div class="col-md-4"><h2 class="text-danger"><?php echo $row_i[8];?></h2></div>
        </div>

        <div class="row">
    <div class="col-md-12"><h4 class="text-danger">EL SOLICITANTE CON LOS DATOS PERSONALES:</h4></div>
   </div>
...
<div class="form-group row">
    ...
    <div class="form-group row">
    <div class="col-sm-4">
    <h4 class="text-danger">CEDULA DE IDENTIDAD:</h4>
   ...
   <div class="row">
    ...
    <div class="col-md-10"><h2 class="text-danger">YA SE ENCONTRABA CONFIRMADO EN EL EVENTO</h2></div>
   </div>
