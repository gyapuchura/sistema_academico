...
<link rel="stylesheet" href="../css/style.css">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">NUEVO DOCENTE</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
	  <div class="row">
		<div class="tg-main-section tg-banner tg-haslayout parallax-window" data-parallax="scroll" data-bleed="100" data-speed="0.2" data-image-src="images/slider/img-03.jpg">
          <h4 align="center"><a href="docentes.php">VOLVER</a></h4>
        </div>
      </div>

    <div class="row">
    <div class="col-md-8"><h3>1.- DATOS PERSONALES DEL DOCENTE:</h3></div>
    <div class="col-md-4"></div>
    </div>
<!-- javascript --->
<form name="FORM9" action="guarda_docente.php" method="post">
...
<div class="box-area">
    ...
    <div class="row">
    <div class="col-md-8"><h3>2.- DATOS COMPLEMENTARIOS DEL DOCENTE:</h3></div>
    <div class="col-md-4"></div>
    </div>

    <div class="box-area">
    <div class="row">
    <div class="col-md-3"><h4>FORMACIÓN ACADÉMICA DOCENTE:</h4></div>
    <div class="col-md-3">
    ...
    <div class="row">
    <div class="col-md-6"><h3>3.- DATOS LABORALES DEL DOCENTE:</h3></div>
    ...
    <div class="row">
    <div class="col-md-3"><h4>DEPENDENCIA LABORAL DEL DOCENTE:</h4></div>
    <div class="col-md-3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        Esta seguro de registrar al nuevo docente?
