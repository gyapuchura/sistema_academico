...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 class="pageTitle">EVENTO SIN CUPO</h2>
			</div>
		</div>
	</div>
	</section>
	...
	<div class="container">
        ...
        <div class="row">
    <div class="col-md-12"><h2 class="text-danger">EL EVENTO YA TIENE EL CUPO MÁXIMO DE INSCRITOS:</h2></div>
   </div>

<!-- MUESTRA EL MENSAJE DE CUPO LLENO --->
<div class="box-area">
