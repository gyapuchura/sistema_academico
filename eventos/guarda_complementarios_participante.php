...
$sql8.=" correo='$correo', celular='$celular', iddepartamento ='$idresidencia', direccion_dom='$direccion_dom' WHERE idnombre_datos='$idnombre_datos' ";
$result8 = mysqli_query($link,$sql8); 

header("Location:mostrar_participante_mod.php");
