...
?>
	...
	<div class="container">
        <div class="row">
        <div class="col-md-8"><h2 class="text-success">LOS DATOS LABORALES :</h2></div>
        <div class="col-md-4"><h2 class="text-success"></h2></div>
        </div>

        <div class="row">
    <div class="col-md-12"><h4 class="text-success">FUERON MODIFICADOS CORRECTAMENTE!!!</h4></div>
   </div>

<!-- MUESTRA LA PREINSCRIPCION REALIZADA --->

   <form name="FORM9" action="mostrar_docente_mod.php" method="post">
    <div class="row">
