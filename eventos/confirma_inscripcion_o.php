...
$sql_c    = " SELECT idevento, cupo_max FROM evento WHERE idevento = '$idevento_ss' ";
$result_c = mysqli_query($link,$sql_c);
$row_c    = mysqli_fetch_array($result_c);
$cupo_max = $row_c[1];

$sql_oc    = " SELECT COUNT(*) FROM inscripcion WHERE idestado_inscripcion='2' AND idevento='$idevento_ss' ";
